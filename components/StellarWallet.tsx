...
export default function StellarWallet({ isHeader = false }: StellarWalletProps) {
  ...
  if (isHeader) {
    return (
      <div className="relative">
        {/* Compact Wallet for Header */}
        <div className="bg-white/95 backdrop-blur-md rounded-full shadow-lg border border-white/30 flex items-center gap-2 px-3 py-1">
          {/* Stellar Icon */}
          ...
          >
            {isBalanceVisible ? <EyeOff className="w-2.5 h-2.5" /> : <Eye className="w-2.5 h-2.5" />}
          </button>
        ...
        {isExpanded && (
          <div className="absolute top-full right-0 mt-2 bg-white/95 backdrop-blur-md rounded-xl shadow-lg border border-white/30 max-w-xs z-50">
            {/* Header */}
